...
if (choosenAlpha > 0.05)
{  
// Mode switch
clr(c_blue, min(choosenAlpha / 2, 0.3));
draw_roundrect_colour_ext(5, 20, 10 + wh[0, 0] + 8, 20 + wh[0, 1], 16, 16, c_black, c_black, false);
clr(c_black, min(choosenAlpha, 1));
draw_roundrect_ext(5, 20, 10 + wh[0, 0] + 8, 20 + wh[0, 1], 16, 16, true);

draw_text(16, 21, "Wiki");
